...
export namespace Json {
	...
	export function readObject(obj: unknown) {
		return typeof obj === "object" && obj !== null && !Array.isArray(obj) ? (obj as { [key: string]: unknown }) : undefined;
	}

	export function readArray<T>(obj: JsonValue | undefined, parser: (obj?: JsonValue) => T): T[] | undefined;
	export function readArray<_T>(obj: JsonValue | undefined): (JsonValue | undefined)[] | undefined;
