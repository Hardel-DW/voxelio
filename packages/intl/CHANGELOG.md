...
- 6fe970e: Version 1.2.0 Intl works in dev and production. Everything is ready for the first official release. Contains only the “Unified” mode. The DX isn't perfect at the moment. You need to import the virtual module manually.
...
- d2f47ca: Fixing the file pattern to include query parameters

## 1.1.4

### Patch Changes

- e58df2d: Debuging the production

## 1.1.3

### Patch Changes

- 7c24ed9: Debuging the production
...
- 991e37a: Fixing oxc import of Visitor not working in production
